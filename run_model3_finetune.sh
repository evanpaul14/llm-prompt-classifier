#!/usr/bin/env bash
# Runs only Model 3 (Full RoBERTa Fine-Tune) in a tmux session,
# then uses `claude -p` to update binary_results.md.

set -euo pipefail

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SESSION="model3_finetune"
...
echo ''
echo '========================================'
echo ' Done. Check binary_results.md.'
echo '========================================'
" Enter
